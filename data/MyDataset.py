...
class PLATEDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == 'train':
            ...
            is_cold_items = is_cold_items.unsqueeze(1)
...
class MetaEmbDataset(Dataset):
    ...
    def __getitem__(self, idx):
        if self.mode == 'train':
            ...
            return user_a_ids, user_b_ids, history_items, history_items_len, target_item_ids,\
                user_a_features, user_b_features, item_features, label_a, label_b, cold_item
